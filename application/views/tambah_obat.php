...
<nav class="navbar">
    ...
    <div class="container">
        ...
        <div class=" card detail-obat w-100 shadow-lg p-3 mb-5 bg-white">
            ...
            <form class="needs-validation" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>Dataobat/input" novalidate >
				<?php //echo form_open_multipart('Dataobat/input');?>
                <div class="form-row " >
                        ...
                        <table class="table form-group table-borderless">
                            <tbody>
                                <tr>
                                    ...
                                    <td >
                                        <input type="text" class="form-control" name="namaObat" placeholder="nama" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="namaMerek" placeholder="merek" required>
                                        <div class="invalid-feedback">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select class="custom-select" name="kategori_obat" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select class="custom-select" name="konsumen" required>
                                              <option value="">dikonsumsi oleh</option>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div class="form-inline">
                                            <input type="number" class="form-control" name="umurSimpan" placeholder="umur simpan" required>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" class="form-control" name="tanggalExpired" placeholder="tanggal kadaluarsa" required>
                                        <div class="invalid-feedback">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select class="custom-select" name="golHamil" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-inline">
                                            <input type="number" min="0" class="form-control" name="stokObat" placeholder="stok obat" required>
                                        <small  class="text-muted ml-2">
                                            Kotak
                                          </small>
                                        <div class="invalid-feedback">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- <div class="custom-file"> -->
                                            <input type="file" class="" name="image" accept=".png, .jpg, .jpeg, .gif" >
                                            <!-- <label class="custom-file-label" for="customFile">Pilih foto ( jpg / png )</label> -->
                                          <!-- </div> -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td >
                                        <textarea class="form-control" name="ketObat" placeholder="manfaat atau cara penggunaan" rows="3"></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <button class="btn btn-sub btn-success float-right" type="submit" >Tambah</button>
			<?php //echo form_close(); ?>
			</form>
...
<div id="successModal" class="modal fade">
	<div class="modal-dialog modal-confirm">
        ...
        <div class="row">
          ...
          <h4 class="modal-title">Berhasil Menambah Obat</h4>
				<p>Silahkan Kembali ke beranda untuk melihat data obat</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-info" data-dismiss="modal">Beranda</button>
